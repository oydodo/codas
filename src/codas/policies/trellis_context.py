...
# Trellis 0.6.2: PRD-only tasks are valid; implement.jsonl / check.jsonl are
# seeded conditionally and curated during planning, so they are not required.
        ...
        for filename in REQUIRED_TASK_FILES:
            ...
            findings.append(
                Finding(
                    ...
                    recommendation="Add the missing prd.md (or task.json); curate optional context with task.py add-context.",
